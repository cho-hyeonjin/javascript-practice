...
// 슬프게도 위 코드에서 야심차게 요놈을 잡으려 했던 catch에서는 throw new Error로 생성한 에러를 잡지 못한다.
// 왜? setTimeout함수는 비동기함수이고, 실행 즉시 종료되며 그것의 콜백이 1초 후 에러를 뱉겠지만 그 전에 setTimeout이 종료됨과 동시에 에러를 잡을 새도 없이 끝나버렸기 때문..
// 이것이 비동기 처리를 위한 전통적인 콜백 패턴에서의 에러 처리 한계의 대표적인 예시이다.
